...
import Direction from 'react-native-vector-icons/AntDesign';
import { Colors } from '../Constant';

const RecDirectAppDetails = ({ navigation }) => {
  return (
    <ScrollView style={styles.container}>
         <View style={styles.card}>
        <View style={styles.resolvedContainer}>
            
          <Text style={styles.resolvedText}> <Icon name='checkcircleo' color="green" size={18} />  Your Consultation has been completed</Text>
      ...
      <TouchableOpacity style={styles.detailsButton} onPress={() => navigation.navigate('AppointmentDetails', { appointmentId: item.id })}>
      <View style={{flexDirection:"row"}}>
      <Direction name='download' color={Colors.secondary} size={20} />
        <Text style={styles.detailsButtonText}>  Download Priscription</Text>
        </View>
      </TouchableOpacity>
      </View>
        </View>
...
export default RecDirectAppDetails;
