...
const Support = () => {
  ...
  const renderItem = ({ item }) => (
    ...
    <View style={{ flexDirection: item.sent ? 'row-reverse' : 'row' }}>
      ...
      <Message name="chatbubble-ellipses" style={{marginRight:5}} size={20} color='#0196A3' />
  ...
  return (
    ...
    >
        {!inputText&& (<View style={{justifyContent:"center"}}>
            <Image style={{width:200,height:200,alignSelf:"center"}} source={require('../../assets/images/message333-removebg-preview.png')}/>
        </View>)}
      <FlatList
        data={messages}
