...
const DirectAppointmentDetails = ({ navigation }) => {
  return (
    <ScrollView style={styles.container}>
      ...
      <TouchableOpacity style={styles.detailsButton} onPress={() => navigation.navigate('AppointmentDetails', { appointmentId: item.id })}>
      <View style={{flexDirection:"row"}}>
      <Direction name='direction' color={Colors.secondary} size={18} />
        <Text style={styles.detailsButtonText}>  Direction</Text>
        </View>
      </TouchableOpacity>
      </View>
        </View>
...
export default DirectAppointmentDetails;
